...
const questoes: QuestaoModel[] = [
    ...
    new QuestaoModel(202, 'Qual fruto é conhecido no Norte e Nordeste como "jerimum"?', desordenar([
    ...
    new QuestaoModel(203, 'Qual é o coletivo de cães?', desordenar([
    ...
    new QuestaoModel(204, 'Qual é o triângiulo que tem todos os lados diferentes?', [
    ...
    new QuestaoModel(306, 'Qual é o bicho que transmite a doença de Chagas?', [
